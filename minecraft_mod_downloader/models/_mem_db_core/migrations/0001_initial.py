    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mod_loader', models.CharField(choices=[('FA', 'Fabric'), ('QU', 'Quilt'), ('FO', 'Forge')], max_length=2, verbose_name='Mod Loader')),
                ('_unique_identifier', models.CharField(max_length=65, validators=[minecraft_mod_downloader.models._mem_db_core.models.validators.UniqueIdentifierValidator(), django.core.validators.MinLengthValidator(2)], verbose_name='Unique Identifier')),
            ],
        ),
        migrations.CreateModel(
            name='ModTag',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=65, unique=True, validators=[minecraft_mod_downloader.models._mem_db_core.models.validators.TagNameValidator(), django.core.validators.MinLengthValidator(2)], verbose_name='Name')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=65, unique=True, validators=[django.core.validators.MinLengthValidator(2)], verbose_name='Name')),
                ('version_id', models.CharField(max_length=20, validators=[minecraft_mod_downloader.models._mem_db_core.models.validators.ShortIDValidator(), django.core.validators.MinLengthValidator(2)], verbose_name='Version ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api_mod_id', models.CharField(max_length=20, validators=[minecraft_mod_downloader.models._mem_db_core.models.validators.ShortIDValidator(), django.core.validators.MinLengthValidator(2)], verbose_name='API Mod ID')),
            ],
            options={
